							...
							<div className="signup-form">
								...
								<form method="POST" onSubmit={this.handleSubmit} className="register-form" id="register-form">									
									<div className="form-group">
										<label htmlFor="uid" className="user-label"><i className="academe academe-uid"></i></label>
										<input type="text" name="uid" id="uid" placeholder="Enrollment ID" value={this.state.uid} onChange={this.handleChange}/>
									</div>
									<div className="form-group">
										<label htmlFor="pass" className="user-label"><i className="academe academe-lock"></i></label>
										<input type="password" name="password" id="password" placeholder="Password" value={this.state.password} onChange={this.handleChange}/>
									</div>
									<div className="form-group">
										<label htmlFor="re-pass" className="user-label"><i className="academe academe-lock-outline"></i></label>
										<input type="password" name="re_pass" id="re_pass" placeholder="Repeat your password"/>
									</div>
									<div className="form-group">
										<input type="checkbox" name="agree-term" id="agree-term" className="agree-term" />
										<label htmlFor="agree-term" className="user-label-agree-term"><span><span></span></span>I agree all statements in  <Link to="/" className="term-service">Terms of service</Link></label>
									</div>
