						...
						<div className = "signin-form">
							...
							<form method="POST" action="" onSubmit={this.handleSubmit} className = "register-form" id="login-form">
								<div className = "form-group">
									<label htmlFor = "uid" className="user-label"><i className = "academe academe-account material-icons-name"></i></label>
									<input placeholder="Enrollment ID" type="text" name="uid" id="uid" value={this.state.uid} onChange={this.handleChange}/>
								</div>
								<div className = "form-group">
									<label htmlFor = "password" className="user-label"><i className = "academe academe-lock"></i></label>
									<input type="password" name="password" id="password" placeholder="Password" value={this.state.password} onChange={this.handleChange}/>
								</div>
								<div className = "form-group">
									<input type="checkbox" name="remember-me" id="remember-me" className = "agree-term" />
									<label htmlFor = "remember-me" className = "user-label-agree-term"><span><span></span></span>Remember me</label>
								</div>
